...
def get_estimator(epochs=20,
    ...
    # Add some data ids to monitor per-sample performance
    csv['id'] = [f't{i}' for i in range(len(csv))]
    ...
    traces = [
        ...
        CSVLogger(filename="log.csv", instance_id_key="id")
    ]
...
if __name__ == "__main__":
    est = get_estimator(train_steps_per_epoch=5, eval_steps_per_epoch=5)
    est.fit()
