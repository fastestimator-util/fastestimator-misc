...
def _download_data(link: str, data_path: str, idx: int,
                   total_idx: int) -> None:
    ...
    if not os.path.exists(data_path):
        print("Downloading data to {}, file: {} / {}".format(
            data_path, idx + 1, total_idx))
...
def load_data(root_dir: Optional[str] = None) -> DirDataset:
    ...
    if not os.path.exists(image_extracted_path):
        ...
        data_paths = [
            os.path.join(root_dir, "images_{}.tar.gz".format(x))
        ...
        for idx, data_path in enumerate(data_paths):
            print("Extracting {}, file {} / {}".format(data_path, idx + 1,
                                                       len(links)))
    ...
    data_subsample(image_extracted_path, 1000)

    return DirDataset(image_extracted_path,
                      file_extension='.png',
